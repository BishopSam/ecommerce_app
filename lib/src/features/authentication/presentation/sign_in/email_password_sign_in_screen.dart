...
class _EmailPasswordSignInContentsState
  ...
  Future<void> _submit(EmailPasswordSignInState state) async {
    ...
    if (_formKey.currentState!.validate()) {
      final controller =
          ref.read(emailSignInControllerProvider(widget.formType).notifier);
  ...
  void _updateFormType(EmailPasswordSignInFormType formType) {
    ...
    ref
        .read(emailSignInControllerProvider(widget.formType).notifier)
        .updateFormtType(formType);
  ...
  Widget build(BuildContext context) {
    ref.listen<AsyncValue>(
        emailSignInControllerProvider(widget.formType)
            .select((state) => state.value), (_, next) {
      next.showAlertDialogOnError(context);
    });
    final state = ref.watch(emailSignInControllerProvider(widget.formType));
